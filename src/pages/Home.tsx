    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-primary-foreground">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">Welcome to Excellence Academy</h1>
          <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto">
            Empowering students to achieve their full potential through innovative education and dedicated teaching
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
              We are committed to providing world-class education that prepares students for success in an ever-changing world.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-gradient-card border-primary/20">
              <CardHeader>
                ...
                <CardDescription>
                  Comprehensive curriculum designed to foster critical thinking and creativity
                </CardDescription>
              </CardHeader>
            </Card>
            <Card className="bg-gradient-card border-primary/20">
            ...
            <Card className="bg-gradient-card border-primary/20">
              <CardHeader>
                ...
                <CardDescription>
                  Track record of student success in academics, sports, and extracurricular activities
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
      ...
      <section id="programs" className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">Comprehensive education from elementary through high school</p>
          </div>
      ...
      <section id="contact" className="py-20 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">Get in touch with us for admissions and inquiries</p>
          </div>
